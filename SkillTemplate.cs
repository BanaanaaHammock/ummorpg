...
public class SkillTemplate : ScriptableObject {
    ...
    public struct SkillLevel {
        ...
        [Range(0, 1)] public float buffsBlock; // % chance to block attacks
        [Range(0, 1)] public float buffsCrit;  // % chance
        public float buffsHpPercentPerSecond; // 0.1=10%; can be negative too
        public float buffsMpPercentPerSecond; // 0.1=10%; can be negative too
        public Projectile projectile; // Arrows, Bullets, Fireballs, ...

        // learn requirements
        public int requiredLevel; // level needed to learn it
        public long requiredSkillExp; // skill experience costs
    }
    [Header("Skill Levels")]
