    ...
    void Update() {
        ...
        if (panel.activeSelf &&
            ...
            tradingButton.onClick.SetListener(() => {
                ...
                inventoryPanel.SetActive(true); // feels better to show it too
                panel.SetActive(false);
            });

            // teleport button
            teleportButton.gameObject.SetActive(npc.teleportTo != null);
            if (npc.teleportTo != null) teleportButton.GetComponentInChildren<Text>().text = "Teleport: " + npc.teleportTo.name;
