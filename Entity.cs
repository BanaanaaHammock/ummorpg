...
public abstract class Entity : NetworkBehaviour {
    ...
    public abstract float block { get; } // % chance to block attacks
    public abstract float crit { get; }  // % chance
    ...
    public void CastSkill(Skill skill) {
        ...
        if (CastCheckSelf(skill, false) && CastCheckTarget(skill)) {
            ...
            else if (skill.category == "Buffatk")
            {
                ...
                mp -= skill.manaCosts;
                skill.buffTimeEnd = Time.time + skill.buffTime;
                DealDamageAt(null, damage + skill.damage, skill.aoeRadius);
